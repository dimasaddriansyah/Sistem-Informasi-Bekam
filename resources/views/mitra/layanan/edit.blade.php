                ...
                <div class="card card-primary">
                  ...
                  <form role="form" action="{{ url('/editPost') }}/{{$layanan->id_layanan}}" method="POST">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="pilihan" id="exampleRadios2" value="Datang Ke Klinik" {{ $layanan->pilihan == 'Datang Ke Klinik' ? 'checked' : ''}}>
