...
<html>
  <head>
    ...
    <title>Sistem Informasi Bekam | Edit Mitra</title>
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">
                      <small>Form </small>Edit Pesanan
                    </h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" action="{{ url('/editPostPesanan')}}/{{ $pesanan->id_pesanan }}" method="post">
                    @csrf
                    <div class="card-body">
