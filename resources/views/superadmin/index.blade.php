...
-->
  <body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
          <img
            src="{{ asset('/tampilan-admin/dist/img/AdminLTELogo.png') }}"
            alt="AdminLTE Logo"
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img
                src="{{ asset('/tampilan-admin/dist/img/user2-160x160.jpg') }}"
    ...
    <script src="{{ asset('/tampilan-admin/dist/js/pages/dashboard3.js') }}"></script>
    @include('sweet::alert')
